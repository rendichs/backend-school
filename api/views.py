...
class SubmissionAnswerViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        if self.request.user.role == "student":
            ...
            if question.assignment != submission.assignment:
                raise PermissionDenied(
    ...
    def perform_update(self, serializer):
        ...
        if self.request.user.role == "student":
            ...
            if instance.submission.student.user != self.request.user:
                raise PermissionDenied(
                    "You can only modify answers in your own submission."
                )
            ...
            if new_submission.student.user != self.request.user:
                raise PermissionDenied(
                    "You cannot change the submission owner."
                )
            ...
            if new_question.assignment != new_submission.assignment:
                raise PermissionDenied(
                    "The question must belong to the submission assignment."
                )
